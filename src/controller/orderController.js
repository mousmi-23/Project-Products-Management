...
const createOrder = async (req, res) => {
    try {
        ...
        return res.status(201).send({ status: true, message: "Order placed successfully", data: orderRes });
    } catch (error) {
...
const updateOrder = async (req, res) => {
    try {
        ...
        return res.status(200).send({ status: true, message: "Status Updated successfully", data: updateRes });
    }
    catch (error) {
        return res.status(500).send({ status: false, message: error.message });
    }
