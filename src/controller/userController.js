...
const AwsService = require('../service/aws');
    ...
    try {
        ...
        bcrypt.compare(password, userRes.password, (err, result) => {
            if (result === true) {
                ...
                const secretKey = "Product-Management32"
                ...
                res.status(200).send({ status: true, message: " User login successfully", data: { userId: payLoad.userId, token: token } })
